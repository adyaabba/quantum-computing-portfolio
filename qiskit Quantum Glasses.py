...
def clear(circuit):
    ...
    """
    print("Clear button pressed")  # Debug line
...
def visualize_circuit(circuit,window):
    ...
    """
    print("Visualise button pressed")  # Debug line
    try:
...
clear_button.grid(row=5, column=0, columnspan=2, sticky= 'WE' , ipadx=5, pady=1) 
